...

{
    ...
    window._$DOMElementHandler$_ = class extends self._$DOMHandler$_ {
        ...
        _$_OnCreate$_(t) {
            const s = t.elementId, i = this._$CreateElement$_(s, t), e = new y(i), h = (this._$_elementMap$_.set(s, e), 
...
{
    const b0 = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent), c0 = /android/i.test(navigator.userAgent), d0 = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/|nwjs)/i.test(navigator.userAgent);
    let h = 0;
...
self["${s}"]();`, document.head.appendChild(e);
    ...
    const h0 = [];
    let e = 0;
    const j0 = 8, k0 = (window.RealFile = window.File, []), l0 = new Map(), m0 = new Map();
    let r = 0;
    const o0 = [], p0 = (self.runOnStartup = function(t) {
    ...
    let s = !1;
    window._$RuntimeInterface$_ = class P0 {
        constructor(t) {
            ...
            d0 && (this._$_useWorker$_ = !1), "cordova" === this._$_exportType$_ && this._$_useWorker$_ && c0) {
        ...
        _$IsiOSCordova$_() {
            return b0 && "cordova" === this._$_exportType$_;
        }
        _$IsiOSWebView$_() {
            const t = navigator.userAgent;
            return b0 && IsWebViewExportType(this._$_exportType$_) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(t);
        }
        _$IsAndroid$_() {
            return c0;
        }
        _$IsAndroidWebView$_() {
            return c0 && IsWebViewExportType(this._$_exportType$_);
        }
        ...
        *_$_CanDoAndroidVirtualKeyboardDetection$_() {
            ...
            yield 0 === this._$_skipAndroidVirtualKeyboardDetection$_, 0 < this._$_skipAndroidVirtualKeyboardDetection$_ && this._$_skipAndroidVirtualKeyboardDetection$_--;
        }
        async _$_Init$_(t) {
            ...
            "nwjs" === this._$_exportType$_ && self.nw) {
                const h = self.nw.Window.get();
                if (h.on("close", () => self.nw.App.quit()), self.nw.App.manifest["c3-steam-mode"]) {
                    let t = 0;
            ...
            if (t.runtimeBaseUrl) this._$_runtimeBaseUrl$_ = t.runtimeBaseUrl; else {
                const n = location.origin, o = (this._$_runtimeBaseUrl$_ = ("null" === n ? "file:///" : n) + location.pathname, 
                this._$_runtimeBaseUrl$_.lastIndexOf("/"));
                -1 !== o && (this._$_runtimeBaseUrl$_ = this._$_runtimeBaseUrl$_.substr(0, o + 1));
            }
        ...
        _$_GetCommonRuntimeOptions$_(t) {
            return {
                ...
                isFullscreen: P0._$IsDocumentFullscreen$_(),
        ...
        async _$_InitWorker$_(t, s) {
            ...
            this._$_domHandlers$_ = k0.map(t => new t(this)), this._$_FindRuntimeDOMHandler$_(), 
        ...
        async _$_InitDOM$_(t, s) {
            ...
            e.setAttribute("interactive", ""), document.body.appendChild(e), this._$_canvasLayers$_.push({
                canvas: i,
                _$htmlWrap$_: e,
                _$lastHtmlLayerDomState$_: {
                    isVisible: !0,
        ...
        _$GetCssDisplayMode$_() {
            ...
            const t = this._$GetExportType$_(), s = new Set([ "cordova", "nwjs", "macos-wkwebview", "linux-cef" ]);
        ...
        ["_OnSetHTMLLayerCount"](t) {
            const i = t.count, s = t.layersDomState, e = t.immediate, h = t.styleWidth + "px", n = t.styleHeight + "px", o = t.marginLeft + "px", r = t.marginTop + "px", a = [], c = [];
            if (i < this._$_canvasLayers$_.length) for (;this._$_canvasLayers$_.length > i; ) {
                const {
                    canvas: l,
                    _$htmlWrap$_: u
                } = this._$_canvasLayers$_.pop();
                u.remove(), this._$_useWorker$_ && !e ? this._$_pendingRemoveElements$_.push(l) : l.remove();
            } else if (i > this._$_canvasLayers$_.length) for (let t = 0, s = i - this._$_canvasLayers$_.length; t < s; ++t) {
                const d = document.createElement("canvas");
                if (d.classList.add("c3overlay"), this._$_useWorker$_) {
                    const w = d.transferControlToOffscreen();
                    a.push(w), c.push(w);
                } else a.push(d);
                document.body.appendChild(d);
                const f = document.createElement("div");
                f.classList.add("c3htmlwrap", "c3overlay"), f.setAttribute("interactive", ""), 
                document.body.appendChild(f), d.style.width = h, d.style.height = n, 
                d.style.marginLeft = o, d.style.marginTop = r, f.style.width = h, 
                f.style.height = n, f.style.marginLeft = o, f.style.marginTop = r, 
                this._$_runtimeDomHandler$_._$_AddDefaultCanvasEventHandlers$_(d), 
                this._$_runtimeDomHandler$_._$_AddDefaultHTMLWrapEventHandlers$_(f), 
                this._$_canvasLayers$_.push({
                    canvas: d,
                    _$htmlWrap$_: f,
                    _$lastHtmlLayerDomState$_: {
            ...
            this._$_UpdateHTMLLayerDOMProperties$_(s);
            for (const p of this._$_domHandlers$_) p instanceof window._$DOMElementHandler$_ && p._$_OnHTMLLayersChanged$_();
            return this._$_UpdateHTMLElementsZOrder$_(), {
                addedCanvases: a,
                transferables: c
            };
        }
        _$_UpdateHTMLLayerDOMProperties$_(i) {
            for (let t = 0, s = Math.min(this._$_canvasLayers$_.length, i.length); t < s; ++t) {
                const {
                    _$htmlWrap$_: e,
                    _$lastHtmlLayerDomState$_: h
                } = this._$_canvasLayers$_[t], n = i[t], o = n.isVisible, r = n.opacity, a = n.isInteractive;
                o !== h.isVisible && (e.style.display = o ? "" : "none", h.isVisible = o), 
                r !== h.opacity && (e.style.opacity = 1 === r ? "" : String(r), 
                h.opacity = r), a !== h.isInteractive && (e.style.pointerEvents = a ? "" : "none", 
                a ? e.setAttribute("interactive", "") : e.removeAttribute("interactive"), 
                h.isInteractive = a);
            }
        }
        ...
        _$_DoUpdateHTMLElementsZOrderOnHTMLLayer$_(t, s) {
            if (!(s.length <= 1 || t >= this._$_canvasLayers$_.length)) {
                const e = s.map(t => t._$GetElement$_()), i = new Set(e), h = this._$GetHTMLWrapElement$_(t), n = Array.from(h.children).filter(t => i.has(t));
                for (let t = 0, s = 0, i = e.length; t < i; ++t) {
                    const o = e[t], r = n[s];
                    o === r ? ++s : h.insertBefore(o, r);
                }
            }
        }
        ...
        _$_OnEventFromRuntime$_(s) {
            const i = s.component, e = s.handler, h = s.data, n = s.responseId, t = l0.get(i);
            if (t) {
                const o = t.get(e);
                if (o) {
                    let t = null;
                    try {
                        ...
                        return console.error(`Exception in '${i}' handler '${e}':`, s), 
                        void (null !== n && this._$_PostResultToRuntime$_(n, !1, "" + s));
                    }
                    if (null === n) return t;
                    t && t.then ? t.then(t => this._$_PostResultToRuntime$_(n, !0, t)).catch(t => {
                        console.error(`Rejection from '${i}' handler '${e}':`, t), 
                        this._$_PostResultToRuntime$_(n, !1, "" + t);
                    }) : this._$_PostResultToRuntime$_(n, !0, t);
                } else console.warn(`[DOM] No handler '${e}' for component '${i}'`);
            } else console.warn(`[DOM] No event handlers for component '${i}'`);
        }
        ...
        _$_OnResultFromRuntime$_(t) {
            const s = t.responseId, i = t.isOk, e = t.result, h = m0.get(s);
            i ? h.resolve(e) : h.reject(e), m0.delete(s);
        }
        _$AddRuntimeComponentMessageHandler$_(t, s, i) {
            let e = l0.get(t);
            if (e || (e = new Map(), l0.set(t, e)), e.has(s)) throw new Error(`[DOM] Component '${t}' already has handler '${s}'`);
            e.set(s, i);
        }
        static _$AddDOMHandlerClass$_(t) {
            if (k0.includes(t)) throw new Error("DOM handler already added");
            k0.push(t);
        }
        ...
        _$_OnWrapperMessage$_(t, s) {
            if ("object" == typeof t && t) {
                const i = t.type;
                if ("directory-handles" === i) this._$_directoryHandles$_ = s; else if ("wrapper-init-response" === i) this._$_wrapperInitResolve$_(t), 
                this._$_wrapperInitResolve$_ = null; else if ("fullscreen-change" === i) P0._$_SetWrapperIsFullscreenFlag$_(t.isFullscreen), 
                this._$_runtimeDomHandler$_._$_OnFullscreenChange$_(); else if ("log-to-console" === i) switch (t.logType) {
                  case "error":
                ...
                } else "extension-message" === i ? this._$PostToRuntimeComponent$_("runtime", "wrapper-extension-message", t) : console.warn("Unknown wrapper message: ", t);
        ...
        _$_ParseDataURI$_(t) {
            ...
            return {
                _$mime_type$_: n,
                data: ("base64" === o || "base64" === r ? atob : decodeURIComponent)(e)
            };
        }
...
{
    const Md = self._$RuntimeInterface$_;
    ...
    const Nd = new Map([ [ "OSLeft", "MetaLeft" ], [ "OSRight", "MetaRight" ] ]), Od = {
    ...
    const Rd = new Set([ "input", "textarea", "datalist", "select" ]);
    function IsKeyboardInputElement(t) {
        return Rd.has(t.tagName.toLowerCase()) || IsInContentEditable(t);
    }
    const Sd = new Set([ "canvas", "body", "html" ]);
    function PreventDefaultOnCanvasOrDoc(t) {
        if (t.target.tagName) {
            const s = t.target.tagName.toLowerCase();
            Sd.has(s) && t.preventDefault();
        }
    }
    ...
    const Ud = "runtime", Vd = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Ud), this._$_enableWindowResizeEvent$_ = !1, this._$_simulatedResizeTimerId$_ = -1, 
        ...
        _$Attach$_() {
            ...
            window.addEventListener("mousedown", t => this._$_OnMouseEvent$_("mousedown", t, Pd)), 
            window.addEventListener("mousemove", t => this._$_OnMouseEvent$_("mousemove", t, Pd)), 
            window.addEventListener("mouseup", t => this._$_OnMouseEvent$_("mouseup", t, Pd)), 
            window.addEventListener("dblclick", t => this._$_OnMouseEvent$_("dblclick", t, Od)), 
            window.addEventListener("wheel", t => this._$_OnMouseWheelEvent$_("wheel", t, Od)), 
        ...
        _$_OnAndroidVirtualKeyboardChange$_(s, i) {
            ...
            document.body.style.transform = "", (this._$_vkTranslateYOffset$_ = 0) < i) {
                ...
                if (e) {
                    ...
                    let t = n - o;
                    0 < (t = (t = i < t ? i : t) < 0 ? 0 : t) && (document.body.style.position = "absolute", 
        ...
        _$_PostRuntimeEvent$_(t, s) {
            this._$PostToRuntime$_(t, s || null, Qd);
        }
        _$_GetWindowInnerWidth$_() {
            ...
            if (!this._$_isExportToVideo$_ && this._$_enableWindowResizeEvent$_) {
                ...
                if (this._$_iRuntime$_._$IsAndroidWebView$_()) {
                    if (this._$_enableAndroidVKDetection$_) {
                        const i = this._$_iRuntime$_._$CanDoAndroidVirtualKeyboardDetection$_();
                        if (i && this._$_lastWindowWidth$_ === t && s < this._$_lastWindowHeight$_) return this._$_virtualKeyboardHeight$_ = this._$_lastWindowHeight$_ - s, 
                ...
                this._$PostToRuntime$_("window-resize", {
                    ...
                    innerHeight: s,
                    devicePixelRatio: window.devicePixelRatio,
                    isFullscreen: Md._$IsDocumentFullscreen$_(),
        ...
        _$_OnFullscreenChange$_() {
            if (!this._$_isExportToVideo$_) {
                const t = Md._$IsDocumentFullscreen$_();
        ...
        _$_OnPointerEvent$_(s, i) {
            if (!this._$_isExportToVideo$_) {
                ...
                }, Od), "mouse" === i.pointerType && (this._$_mousePointerLastButtons$_ = i.buttons);
            }
        }
    ...
    Md._$AddDOMHandlerClass$_(Vd);
}

{
    const Af = "dispatchworker.js", Bf = "jobworker.js";
    self._$JobSchedulerDOM$_ = class {
        ...
        async _$Init$_() {
            ...
            const t = this._$_runtimeInterface$_._$GetScriptFolder$_() + Af, s = (this._$_dispatchWorker$_ = await this._$_runtimeInterface$_._$CreateWorker$_(t, {
                name: "DispatchWorker"
            }), new MessageChannel());
        ...
        async _$_CreateJobWorker$_() {
            const t = this._$_jobWorkers$_.length, s = this._$_runtimeInterface$_._$GetScriptFolder$_() + Bf, i = await this._$_runtimeInterface$_._$CreateWorker$_(s, {
                name: "JobWorker" + t
...
{
    function IsVideoPlaying(t) {
        return t && !t.paused && !t.ended && 0 < t.currentTime;
    }
    const Kf = "video", Lf = class extends self._$DOMElementHandler$_ {
        constructor(t) {
            super(t, Kf), this._$SetAutoAttach$_(!1), this._$_isRuntimeInWorker$_ = !1, 
            this._$_supportsRvfc$_ = !1, this._$_postImageBitmaps$_ = !1, this._$_sequenceNumber$_ = 0, 
            this._$_numVideos$_ = 0, this._$_destroyedVideos$_ = new WeakSet(), 
            this._$AddRuntimeMessageHandler$_("init", t => this._$_OnInit$_(t)), 
            this._$AddDOMElementMessageHandlers$_([ [ "play", t => this._$_OnPlay$_(t) ], [ "pause", t => this._$_OnPause$_(t) ], [ "set-source", (t, s) => this._$_OnSetSource$_(t, s) ], [ "set-playback-time", (t, s) => this._$_OnSetPlaybackTime$_(t, s) ], [ "set-playback-rate", (t, s) => this._$_OnSetPlaybackRate$_(t, s) ], [ "set-looping", (t, s) => this._$_OnSetLooping$_(t, s) ], [ "set-muted", (t, s) => this._$_OnSetMuted$_(t, s) ], [ "set-volume", (t, s) => this._$_OnSetVolume$_(t, s) ] ]), 
            self.C3Video_GetElement = t => this._$GetElementById$_(t);
        }
        async _$_OnInit$_(t) {
            this._$_isRuntimeInWorker$_ = t.isInWorker;
            const s = document.createElement("video"), i = (this._$_supportsRvfc$_ = !!s.requestVideoFrameCallback && !this._$_iRuntime$_._$IsAndroidWebView$_(), 
            !!self.createImageBitmap);
            return this._$_postImageBitmaps$_ = this._$_isRuntimeInWorker$_ || i, 
            {
                postImageBitmaps: this._$_postImageBitmaps$_,
                supportedFormats: {
                    "webm-vp8": !!s.canPlayType("video/webm;codecs=vp8"),
                    "webm-vp9": !!s.canPlayType("video/webm;codecs=vp9"),
                    "webm-av1": !!s.canPlayType("video/webm;codecs=av01.0.00M.08"),
                    "mp4-h264": !!s.canPlayType("video/mp4;codecs=avc1.420034"),
                    "mp4-h265": !!s.canPlayType("video/mp4;codecs=hev1.1.2.L93.B0"),
                    "mp4-av1": !!s.canPlayType("video/mp4;codecs=av01.0.00M.08")
                }
            };
        }
        _$TryPlayMedia$_(t) {
            this._$_iRuntime$_._$TryPlayMedia$_(t), this._$_postImageBitmaps$_ && this._$_supportsRvfc$_ && -1 === t.c3_rvfcId && (t.c3_rvfcId = t.requestVideoFrameCallback(() => this._$_OnVideoFrameCallback$_(t)));
        }
        _$RemovePendingPlay$_(t) {
            this._$_iRuntime$_._$RemovePendingPlay$_(t), this._$_postImageBitmaps$_ && this._$_supportsRvfc$_ && -1 !== t.c3_rvfcId && (t.cancelVideoFrameCallback(t.c3_rvfcId), 
            t.c3_rvfcId = -1);
        }
        async _$_OnVideoFrameCallback$_(t) {
            if (!this._$_destroyedVideos$_.has(t)) {
                t.c3_rvfcId = t.requestVideoFrameCallback(() => this._$_OnVideoFrameCallback$_(t));
                try {
                    const s = t.c3_sequenceNumber++, i = await createImageBitmap(t);
                    s > t.c3_lastFrameSequence && (t.c3_imageBitmap = i, t.c3_lastFrameSequence = s);
                } catch (t) {}
            }
        }
        _$CreateElement$_(t, s) {
            const i = document.createElement("video"), e = (i.crossOrigin = "anonymous", 
            i.playsInline = !0, i.c3_imageBitmap = null, i.c3_rvfcId = -1, i.c3_sequenceNumber = 0, 
            i.c3_lastFrameSequence = -1, i.addEventListener("canplay", () => this._$_SendPlaybackEvent$_(i, t, 0)), 
            i.addEventListener("canplaythrough", () => this._$_SendPlaybackEvent$_(i, t, 1)), 
            i.addEventListener("ended", () => this._$_SendPlaybackEvent$_(i, t, 2)), 
            i.addEventListener("error", () => this._$_SendPlaybackEvent$_(i, t, 3)), 
            i.addEventListener("loadstart", () => this._$_SendPlaybackEvent$_(i, t, 4)), 
            i.addEventListener("playing", () => this._$_SendPlaybackEvent$_(i, t, 5)), 
            i.addEventListener("pause", () => this._$_SendPlaybackEvent$_(i, t, 6)), 
            i.addEventListener("stalled", () => this._$_SendPlaybackEvent$_(i, t, 7)), 
            s.autoplay);
            return 0 === e ? (i.autoplay = !1, i.preload = "none") : 1 === e ? (i.autoplay = !1, 
            i.preload = "auto") : i.autoplay = !0, s.src && (i.src = s.src), 2 === e && this._$TryPlayMedia$_(i), 
            this._$_numVideos$_++, this._$_StartTicking$_(), i;
        }
        _$_SendPlaybackEvent$_(t, s, i) {
            this._$_destroyedVideos$_.has(t) || this._$PostToRuntimeElement$_("playback-event", s, {
                type: i
            });
        }
        _$UpdateState$_(t, s) {}
        _$DestroyElement$_(t) {
            this._$RemovePendingPlay$_(t), IsVideoPlaying(t) && t.pause(), t.src = "", 
            this._$_numVideos$_ = Math.max(this._$_numVideos$_ - 1, 0), 0 === this._$_numVideos$_ && this._$_StopTicking$_(), 
            this._$_destroyedVideos$_.add(t);
        }
        _$_OnPlay$_(t) {
            this._$TryPlayMedia$_(t);
        }
        _$_OnPause$_(t) {
            this._$RemovePendingPlay$_(t), t.pause();
        }
        _$_OnSetSource$_(t, s) {
            t.src = s.src, t.load();
        }
        _$_OnSetPlaybackTime$_(t, s) {
            try {
                t.currentTime = s.time;
            } catch (t) {
                console.error("[Video] Exception setting playback time: ", t);
            }
        }
        _$_OnSetPlaybackRate$_(t, s) {
            try {
                t.playbackRate = s.rate;
            } catch (t) {
                console.error("[Video] Exception setting playback rate: ", t);
            }
        }
        _$_OnSetLooping$_(t, s) {
            t.loop = s.isLooping;
        }
        _$_OnSetMuted$_(t, s) {
            t.muted = s.isMuted;
        }
        _$_OnSetVolume$_(t, s) {
            t.volume = s.volume;
        }
        _$Tick$_() {
            const t = {}, s = {
                sequenceNumber: this._$_sequenceNumber$_++,
                videoData: t
            }, i = [], e = [];
            for (const [ h, n ] of this._$_elementMap$_.entries()) {
                const o = n._$GetElement$_(), r = {
                ...
                if (this._$_postImageBitmaps$_) if (this._$_supportsRvfc$_) {
                    const a = o.c3_imageBitmap;
                    o.c3_imageBitmap = null, (r.imageBitmap = a) && i.push(a);
                } else e.push(createImageBitmap(o).then(t => {
                    r.imageBitmap = t, i.push(t);
                }).catch(t => {
                    r.imageBitmap = null;
                }));
                t[h.toString()] = r;
            ...
            Promise.all(e).then(() => {
                this._$_isRuntimeInWorker$_ ? this._$PostToRuntime$_("state", s, !1, i) : this._$_PostToRuntimeMaybeSync$_("state", s);
            });
        }
    };
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(Lf);
}

{
    const T5 = "mouse", U5 = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, T5), this._$AddRuntimeMessageHandlers$_([ [ "cursor", t => this._$_OnChangeCursorStyle$_(t) ], [ "request-pointer-lock", t => this._$_OnRequestPointerLock$_(t) ], [ "release-pointer-lock", () => this._$_OnReleasePointerLock$_() ] ]), 
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(U5);
}

{
    const ag = "touch", bg = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, ag), this._$AddRuntimeMessageHandler$_("request-permission", t => this._$_OnRequestPermission$_(t));
        }
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(bg);
}

{
    const lg = 180 / Math.PI, mg = "audio";
    self._$AudioDOMHandler$_ = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, mg), this._$_audioContext$_ = null, this._$_destinationNode$_ = null, 
            ...
            this._$_analysers$_ = new Set(), this._$_isPendingPostFxState$_ = !1, 
        ...
        async _$_CreateAudioContext$_(t) {
            t.usePlayMusicAsSoundWorkaround && (this._$_playMusicAsSound$_ = !0), 
            ...
            this._$_rolloffFactor$_ = t.rolloffFactor, this._$_iRuntime$_._$IsExportingToVideo$_() ? (this._$_playMusicAsSound$_ = !0, 
            this._$_audioContext$_ = new OfflineAudioContext({
                numberOfChannels: 2,
                sampleRate: 48e3,
                length: Math.ceil(48e3 * this._$_iRuntime$_._$GetExportToVideoDuration$_())
            })) : (this._$_audioContext$_ = new AudioContext({
            ...
            }), this._$_destinationNode$_ = this._$_audioContext$_.createGain(), 
            this._$_destinationNode$_.connect(this._$_audioContext$_.destination);
        ...
        _$ReleaseAllMusicBuffersExceptLast$_() {
            ...
            for (let t = 0, s = this._$_audioBuffers$_.length; t < s; ++t) {
                ...
                (this._$_audioBuffers$_[i] = e)._$IsMusic$_() && e !== this._$_lastMusicBuffer$_ ? e._$Release$_() : ++i;
            }
        ...
        *_$audioInstancesByEffectTag$_(t) {
        ...
        async _$_GetAudioBuffer$_(t, s, i, e, h) {
            for (const o of this._$_audioBuffers$_) if (o._$GetUrl$_() === s) return e && this._$_playMusicAsSound$_ && (this._$_lastMusicBuffer$_ = o), 
            await o._$Load$_(), o;
            if (h) return null;
        ...
        async _$_GetAudioInstance$_(t, s, i, e, h) {
            for (const r of this._$_audioInstances$_) if (r._$GetUrl$_() === s && (r._$CanBeRecycled$_() || h)) return h && this._$_playMusicAsSound$_ && (this._$_lastMusicBuffer$_ = r._$GetBuffer$_()), 
            r._$SetTags$_(e), r;
        ...
        async _$_LoadAudioInstance$_(s, i) {
            if (3 !== i) {
                const e = s.bufferOriginalUrl, h = s.bufferUrl, n = s.bufferType, o = s.isMusic, r = s.tags, a = s.isLooping, c = s.volume, l = s.playbackTime;
                if ((!o || 1 !== i) && (o || 2 !== i)) {
                    let t = null;
                    try {
                        t = await this._$_GetAudioInstance$_(e, h, n, r, o);
                    } catch (i) {
                        return void console.error("[Construct] Audio: error loading audio state: ", i);
                    }
                    t._$LoadPanState$_(s.pan), t._$LoadStereoPanState$_(s.stereoPan), 
                    t.Play(a, c, l, 0), s.isPlaying || t._$Pause$_(), t._$_LoadAdditionalState$_(s);
                }
            }
        }
...
self._$C3AudioBuffer$_ = class {
    ...
    static _$Create$_(t, s, i, e, h) {
        return new (!h || t._$IsPlayMusicAsSound$_() ? self._$C3WebAudioBuffer$_ : self._$C3Html5AudioBuffer$_)(t, s, i, e, h);
    }
    ...
    async _$_Load$_() {
        try {
            this._$_loadState$_ = "loading", await this._$_Fetch$_(), this._$WasReleased$_() || (await this._$_Decode$_(), 
...
self._$C3Html5AudioInstance$_ = class extends self._$C3AudioInstance$_ {
    ...
    _$GetPlaybackTime$_() {
        ...
        return this._$_isLooping$_ ? t : Math.min(t, this._$GetDuration$_());
    }
    Play(t, s, i, e) {
    ...
    _$GetPlaybackTime$_() {
        ...
        this._$_isLooping$_ ? t : Math.min(t, this._$GetDuration$_());
    }
    Play(t, s, i, e) {
...

{
    ...
    self._$C3AudioFilterFX$_ = class extends g9 {
    ...
    }, self._$C3AudioDelayFX$_ = class extends g9 {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioConvolveFX$_ = class extends g9 {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioFlangerFX$_ = class extends g9 {
    ...
    }, self._$C3AudioPhaserFX$_ = class extends g9 {
        constructor(t, s, i, e, h, n, o) {
    ...
    }, self._$C3AudioGainFX$_ = class extends g9 {
        constructor(t, s) {
    ...
    }, self._$C3AudioStereoPanFX$_ = class extends g9 {
        constructor(t, s) {
    ...
    }, self._$C3AudioTremoloFX$_ = class extends g9 {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioRingModFX$_ = class extends g9 {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioDistortionFX$_ = class extends g9 {
        constructor(t, s, i, e, h, n) {
    ...
    }, self._$C3AudioCompressorFX$_ = class extends g9 {
        constructor(t, s, i, e, h, n) {
        ...
        _$SetParam$_(t, s, i, e) {}
    }, self._$C3AudioAnalyserFX$_ = class extends g9 {
        constructor(t, s, i) {
